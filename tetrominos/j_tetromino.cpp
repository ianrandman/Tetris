...
const Coordinate JTetromino::orientation1[numRows + numRows*numCols] = {
...
const Coordinate JTetromino::orientation2[numRows + numRows*numCols] = {
...
const Coordinate JTetromino::orientation3[numRows + numRows*numCols] = {
...
const Coordinate JTetromino::orientation4[numRows + numRows*numCols] = {
