...
const Coordinate ITetromino::orientation1[numRows + numRows*numCols] = {
...
const Coordinate ITetromino::orientation2[numRows + numRows*numCols] = {
...
const Coordinate ITetromino::orientation3[numRows + numRows*numCols] = {
  Coordinate(0, 0, Color::Black)     , Coordinate(0, 1, Color::Black)     , Coordinate(0, 2, Color::Black)     , Coordinate(0, 3, Color::Black)     ,
...
const Coordinate ITetromino::orientation4[numRows + numRows*numCols] = {
