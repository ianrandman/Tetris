...
const Coordinate LTetromino::orientation1[numRows + numRows*numCols] = {
...
const Coordinate LTetromino::orientation2[numRows + numRows*numCols] = {
...
const Coordinate LTetromino::orientation3[numRows + numRows*numCols] = {
...
const Coordinate LTetromino::orientation4[numRows + numRows*numCols] = {
